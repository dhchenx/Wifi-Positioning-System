...
public class RSSILBS {
	...
	// 返回最终预测的目标位置
	public String GetFinalTarget(String areaid,String saveid,String val) {
		...
		return this.GetLocation(areaid,this.Locate(areaid,saveid,macs, values));
	}

	public String GetLocation(String areaid,List<String> locs) {
		// 各备选位置权重计算
		// 获得各个唯一的地址
	...
	public List<String> CheckLoc(String areaid,String saveid,List<String> locs,String[] t_mac,String[] t_mac_val,double[] t_val){
		String r="";
		r = Check(areaid,saveid,t_mac, t_mac_val, t_val);
		if (r != null)
			locs.add(r);
	...
	// 获取各个类似的地址
	public List<String> Locate(String areaid,String saveid,String[] macs, double[] vals) {
		...
		//具有5个MAC地址
		if(mac_count>=5){
			locs=CheckLoc(areaid,saveid,locs,
		...
		if (mac_count >= 3) {
			...
			r = Check(areaid,saveid,t_mac, t_mac_val, vals);
			if (r != null)
				locs.add(r);
	 ...
	 */
	public String Check(String areaid,String saveid,String[] t_mac, String[] t_mac_val, double[] vals) {
		// 3 MAC

		RSSIArea[] ra = this.GetRoomList(areaid,saveid,t_mac, t_mac_val);
	...
	//sqlite imp
	public RSSIArea[] GetRoomList(String areaid,String saveid,String[] tmac,String[] tval ){
		  String[][] result=wdb.getRSSIData("select * from wifilbs_rssi", new String[]{"roomid","mac1","val1","mac2"
	        		,"val2","mac3","val3","mac4","val4","mac5","val5","span1","span2",
	        		"span3","span4","span5"
	        },this.GetSelectCondition(areaid,saveid,tmac, tval));
	...
	public String GetSelectCondition(String areaid,String saveid,String[] macnames, String[] macvalues) {
		String str = "";
		...
		str += " and areaid='"+areaid+"' and saveid='"+saveid+"'";
	...
	public String GetSelectStr(String[] macnames, String[] macvalues) {
		String str = "select * from "+Config.wifilbs_rssi+" where ";
		for (int i = 0; i < macnames.length; i++) {
			if (i != macnames.length - 1) {
				str += macnames[i] + "='" + macvalues[i] + "' and ";
			} else {
